...
String WebServer::buildPage(const std::vector<StringConvertibleVariable*> & vars) {
  Log("Page requested");
  String first = "<!DOCTYPE html><title>AP WIFI CONFIG</title><meta content=\"width=device-width,user-scalable=no\"name=viewport><link href=style rel=stylesheet><link rel=\"stylesheet\" href=\"https://fonts.googleapis.com/css?family=Righteous\"><script src=script></script><div id=cf><h1>AP Wifi</h1>";
  String middle = "";
